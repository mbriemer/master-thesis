...
The first requires, roughly speaking, that the generator is parametric, that is, he depends smoothly on the parameters, has non-exploding, non-vanishing Fisher information, therefore can be stably inverted, and that the inverted generator is also parametric in this sense. %TODO think if true %TODO why does this imply parametric?
...
I it is a stronger version of assumption \ref{a:1}, but requires a higher degree of smoothness, namely the twice differentiability of the likelihood of the generator in the parameters and observations.%TODO maybe expand
